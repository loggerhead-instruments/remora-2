...
// testing current consumption of adafruit library
// 11 mA on Remora2 with 20 Hz sampling
...
uint16_t measurement_delay_us = 50000;// Delay between measurements for testing
...
void setup(void) {
  ...
  pinMode(PLAY_POW, OUTPUT); // PD6
    digitalWrite(REC_POW, LOW);  // turn on Teensy so can reprogram
